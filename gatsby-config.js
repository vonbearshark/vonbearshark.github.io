...
module.exports = {
  siteMetadata: {
    ...
    portfolio: [
      ...
      {
        description:
          "Top 10 Reasons Only 90s Kids Believe What This Chrome Browser Extension Does!",
        link:
          "https://chrome.google.com/webstore/detail/infinite-viral/gejghfapdoblkdeghocaggoalocccacg",
      ...
      {
        description:
          "An Array of Things sensor data pipeline and visualization dashboard.",
